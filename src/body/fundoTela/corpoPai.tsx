...
export default function CorpoPai() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-gradient-to-b from-[#0f1729] to-[#0f1729]  text-white">
      ...
      <div className="flex rounded-lg w-full justify-center  backdrop-blur-2xl bg-gray-700/40 border border-none ">
        <span className="flex  text-4xl font-bold tracking-tight text-slate-100 ">
          Matheus Filipe
        </span>
      </div>
